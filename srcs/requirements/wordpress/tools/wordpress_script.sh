...
if [ ! -f /var/www/wordpress/wp-config.php ]; then
	...
	wp-cli core install --url=$DOMAIN_NAME --title=$WEB_TITLE --admin_user=$MYSQL_USERNAME_ADMIN --admin_password=$MYSQL_PASSWORD_ADMIN --admin_email=$WEB_EMAIL --allow-root;
